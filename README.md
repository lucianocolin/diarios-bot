...
búsqueda del tema (`https://x.com/search?q=<tema>`). X abre la pestaña "Top" por
defecto y muestra lo más relevante, videos incluidos.

Se probó primero agregando `filter:videos -filter:replies&f=top` a la URL, pero
esos links no abrían bien desde el celular. La búsqueda pelada funciona.
...
post), así que traer los posts directamente costaría unos US$30 al mes.
